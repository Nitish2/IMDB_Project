...
import com.example.hp.imdb.json.Json_Data;
...
public class MovieDetail_Activity extends AppCompatActivity implements View.OnClickListener
{
    ...
    Database movieDbHelper = new Database(MovieDetail_Activity.this);
        ...
        if (v.getId() == R.id.imageView_favorites)
        {
            ...
            if (movieDbHelper.MovieIDExist(parseInt(id)))
            {
                if (imdb.getFavorite() == 0)
                {
                    ...
                    Toast.makeText(getBaseContext(), "Added to the favorites", Toast.LENGTH_SHORT).show();
    ...
    class JSON_movieDetails extends AsyncTask<Void, Void, Void>
    {
        ...
        protected Void doInBackground(Void... params)
        {
            ...
            Json_Data jsondata_movieDetails = new Json_Data();
    ...
    class JSON_moviePosters extends AsyncTask<Void, Void, Void>
    {
        ...
        protected Void doInBackground(Void... params)
        {
            JSONArray jsonArray;
            JSONObject jsonObject;
            Json_Data jsondata_moviePosters = new Json_Data();
    ...
    class JSON_movieCast extends AsyncTask<Void, Void, Void>
    {
        ...
        protected Void doInBackground(Void... params)
        {
            URL_movieCastCrew = "http://api.themoviedb.org/3/movie/" + imdb_id +
                    "/credits?api_key=8496be0b2149805afa458ab8ec27560c";
            JSONArray jsonArray;
            JSONObject jsonObject;
            Json_Data jsondata_movieCast = new Json_Data();
        ...
        protected void onPostExecute(Void aVoid)
        {
            ...
            for (int i = 0; i < arrayList_movieCast.size(); i++)
            {
                ...
                LinearLayout cast_crew = (LinearLayout) layoutInflater.inflate(R.layout.cast_crew, null);
                ImageView imageView_cast_crew = (ImageView) cast_crew.findViewById(R.id.imageView_cast_crew);
                TextView textView_name = (TextView) cast_crew.findViewById(R.id.textView_name);
                TextView textView_role = (TextView) cast_crew.findViewById(R.id.textView_role);
                ...
                linearLayout_cast.addView(cast_crew);
            }
        }
    }
    ...
    class JSON_movieCrew extends AsyncTask<Void, Void, Void>
    {
        ...
        protected Void doInBackground(Void... params)
        {
            ...
            JSONArray jsonArray;
            JSONObject jsonObject;
            Json_Data jsondata_movieCrew = new Json_Data();
        ...
        protected void onPostExecute(Void aVoid)
        {
            ...
            for (int i = 0; i < arrayList_movieCrew.size(); i++)
            {
                ...
                LinearLayout cast_crew = (LinearLayout) layoutInflater.inflate(R.layout.cast_crew, null);
                ImageView imageView_cast_crew = cast_crew.findViewById(R.id.imageView_cast_crew);
                TextView textView_name =  cast_crew.findViewById(R.id.textView_name);
                TextView textView_role =  cast_crew.findViewById(R.id.textView_role);
                ...
                linearLayout_crew.addView(cast_crew);
            }
        }
    }
