...
import static com.example.hp.imdb.MainActivity.MOVIE_ID;
...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view_movieList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(mcontext, MovieDetail_Activity.class);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        imageLoader.displayImage(currentMovie.get(MainActivity.MOVIE_IMAGE),
                holder.imageView_movieImage, new ImageLoadingListener() {
            @Override
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView textView_movieTitle, textView_releaseDate_label, textView_releaseDate,
                textView_popularity_label, textView_voteCount;

        ViewHolder(final View itemView) {
            super(itemView);
            progressBar = itemView.findViewById(R.id.progressbar);
            imageView_movieImage = itemView.findViewById(R.id.imageView_mImage);
            textView_movieTitle = itemView.findViewById(R.id.textView_movieTitle);
            textView_releaseDate_label =  itemView.findViewById(R.id.textView_releaseDate_label);
            textView_releaseDate = itemView.findViewById(R.id.textView_releaseDate);
            textView_popularity_label =  itemView.findViewById(R.id.textView_popularity_label);
            ratingBar_popularity = itemView.findViewById(R.id.ratingBar_popularity);
            imageView_voteCount =  itemView.findViewById(R.id.imageView_voteCount);
            textView_voteCount = itemView.findViewById(R.id.textView_voteCount);
